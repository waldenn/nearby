...
var wikishootme = {
	...
	tile_layers : {
		osm: {name:'OSM (WMF)',url:'https://tile.openstreetmap.org/{z}/{x}/{y}.png',attribution:'&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors'} ,
	...
	createImageThumbnail : function ( image, entry ) {
		...
		h += "<img src='" + url + "' border=0 width='"+me.thumb_size+"px' height='"+me.thumb_size+"px' alt='' />" ;
		h += "</a></div>" ;
...
//			h += "</div>" ;
		    ...
		    //h += '<a href="javascript:void(0)" title="video" onclick="gotoUrl(&quot;' + 'https://conze.pt/app/video/#/search/' + encodeURIComponent( entry.label ) + '&quot;)"><i class="fab fa-youtube"></i></a> ' ;
...
window.gotoArticle = function( title, qid ){
  ...
  var url = 'https://conze.pt/app/wikipedia/?t=' + encodeURIComponent( title ) + '&l=' + lang + '&qid=' + qid ;
